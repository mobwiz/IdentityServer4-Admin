...
{
    [Table(Name = "tbl_admin_reference_token")]
    [Index("idx_expireTime", "expire_time", false)]
    [Index("idx_sub_client_company_sid", "subject_id,client_id,company_id,session_id", false)]
    public class MReferenceToken : IModel
    {
        /// <summary>
        /// 主键
        /// </summary>
